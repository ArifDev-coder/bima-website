...
export const metadata: Metadata = {
  title: "Tentang Kami | Bima Eggs",
  description: "Pelajari sejarah dan komitmen Bima Eggs dalam menyediakan protein terbaik untuk keluarga sejak 2010.",
};
  ...
  return (
    <div className="bg-white">
      ...
      <section className="bg-brand-secondary text-white py-20 text-center">
        <h1 className="text-4xl md:text-5xl font-extrabold mb-4">Tentang Bima Eggs</h1>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-stone-600 leading-relaxed mb-4">
              Bima Eggs bermula dari sebuah peternakan kecil di kaki Gunung Salak pada tahun 2010. 
            ...
            <p className="text-stone-600 leading-relaxed">
              ...
              restoran, dan hotel di seluruh wilayah Jabodetabek. Konsistensi dan integritas adalah kunci kami.
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-brand-bg p-8 rounded-2xl border border-brand-accent">
            ...
            <p className="text-stone-700">
              Menjadi penyedia telur ayam ras nomor satu di Indonesia yang dikenal karena 
